...
@section('title','Home || Mankar Institute of Education and Research of Pharmacy Science' )   
@section('content')
<!-- ==============================================
    ** Banner Carousel **
    =================================================== -->
        ...
        <div class="container">
            <ul class="row our-links">
                <li class="col-sm-4 apply-online clearfix equal-hight">
                    <div class="icon"><img src="{{ asset('assets/frontend/images/apply-online-ico.png') }}" class="img-responsive" alt=""></div>
                    <div class="detail">
                        <h3>Apply Online</h3>
                ...
                <li class="col-sm-4 prospects clearfix equal-hight">
                    <div class="icon"><img src="{{ asset('assets/frontend/images/prospects-ico.png') }}" class="img-responsive" alt=""></div>
                    <div class="detail">
                ...
                <li class="col-sm-4 certification clearfix equal-hight">
                    <div class="icon"><img src="{{ asset('assets/frontend/images/certification-ico.png') }}" class="img-responsive" alt=""></div>
                    <div class="detail">
                        <h3>Certification</h3>
                        <p>Lorem Ipsum is simply dummy text of the printing...</p>
                        <a href="#" class="more"><i class="fa fa-angle-right" aria-hidden="true"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-sm-5 col-sm-pull-7">
                    <div class="video-block">
                        <div id="thumbnail_container"> <img src="{{ asset('assets/frontend/images/about-video.jpg') }}" id="thumbnail" class="img-responsive" alt=""> </div>
                        <a href="https://www.youtube.com/watch?v=i11RXCJVEnw" class="start-video video"><img src="{{ asset('assets/frontend/images/play-btn.png') }}" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="our-cources padding-lg">
        <div class="container">
            ...
            <ul class="course-list owl-carousel">
                <li>
                    <div class="inner">
                        <figure><img src="{{ asset('assets/frontend/images/course-img1.jpg') }}" alt=""></figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{ asset('assets/frontend/images/course-img2.jpg') }}" alt=""></figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{ asset('assets/frontend/images/course-img3.jpg') }}" alt=""></figure>
                ...
                <li>
                    <div class="inner">
                        <figure><img src="{{ asset('assets/frontend/images/course-img4.jpg') }}" alt=""></figure>
        ...
        <div class="container">
            <ul class="row">
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ asset('assets/frontend/images/study-time-ico.jpg') }}" alt="Malleable Study Time">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ asset('assets/frontend/images/placement-ico.jpg') }}" alt="Placement Assistance">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ asset('assets/frontend/images/easy-access-ico.jpg') }}" alt="Easy To Access">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ asset('assets/frontend/images/study-go-ico.jpg') }}" alt="Study on the Go">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ asset('assets/frontend/images/get-innovative-ico.jpg') }}" alt="Get an Innovative, In-depth Transition">
                ...
                <li class="col-sm-4 equal-hight">
                    <div class="inner"> <img src="{{ asset('assets/frontend/images/practical-ico.jpg') }}" alt="Practical & Interactive Participation">
        ...
        <div class="container">
            ...
            <ul class="row">
                <li class="col-sm-4">
                    ...
                    <figure><img src="{{ asset('assets/frontend/images/how-study-img1.jpg') }}" class="img-responsive" alt=""></figure>
                </li>
                <li class="col-sm-4">
                    <div class="overly">
                        <div class="cnt-block">
                    ...
                    <figure><img src="{{ asset('assets/frontend/images/how-study-img2.jpg') }}" class="img-responsive" alt=""></figure>
                </li>
                <li class="col-sm-4">
                    <div class="overly">
                        <div class="cnt-block">
                    ...
                    <figure><img src="{{ asset('assets/frontend/images/how-study-img3.jpg') }}" class="img-responsive" alt=""></figure>
                </li>
            </ul>
        </div>
    </section>
    ...
    <section class="news-events padding-lg">
        <div class="container">
            ...
            <ul class="row cs-style-3">
                <li class="col-sm-4">
                    <div class="inner">
                        <figure> <img src="{{ asset('assets/frontend/images/new-event-img1.jpg') }}" class="img-responsive">
                            <figcaption>
                ...
                <li class="col-sm-4">
                    <div class="inner">
                        <figure> <img src="{{ asset('assets/frontend/images/new-event-img2.jpg') }}" class="img-responsive">
                            <figcaption>
                                <div class="cnt-block"> <a href="news.html" class="plus-icon">+</a>
                                    <h3>We have added new features to Dream Palace</h3>
                                    <div class="bottom-block clearfix">
                ...
                <li class="col-sm-4">
                    <div class="inner">
                        <figure> <img src="{{ asset('assets/frontend/images/new-event-img3.jpg') }}" class="img-responsive">
                            <figcaption>
                                <div class="cnt-block"> <a href="news.html" class="plus-icon">+</a>
                                    <h3>We have added new features to Dream Palace</h3>
                                    <div class="bottom-block clearfix">
        ...
        <ul class="gallery clearfix">
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg1.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour1.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg2.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour2.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg3.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour3.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg4.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour4.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg5.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour5.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg6.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour6.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg7.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour7.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg8.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour8.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg9.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour9.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
            <li>
                <div class="overlay">
                    <h3>Lorem ipsum</h3>
                    <p>Lorem ipsum</p>
                    <a class="galleryItem" href="{{ asset('assets/frontend/images/tour-lg10.jpg') }}"><span class="icon-enlarge-icon"></span></a>
                    <a href="gallery.html" class="more"><span class="icon-gallery-more-arrow"></span></a>
                </div>
                <figure><img src="{{ asset('assets/frontend/images/tour10.jpg') }}" class="img-responsive" alt=""></figure>
            </li>
        </ul>
    </section>
    ...
    <section class="logos">
        <div class="container">
            <ul class="owl-carousel clearfix">
                <li><a href="#"><img src="{{ asset('assets/frontend/images/logo1.jpg') }}" class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ asset('assets/frontend/images/logo2.jpg') }}" class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ asset('assets/frontend/images/logo3.jpg') }}" class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ asset('assets/frontend/images/logo4.jpg') }}" class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ asset('assets/frontend/images/logo5.jpg') }}" class="img-responsive" alt=""></a></li>
                <li><a href="#"><img src="{{ asset('assets/frontend/images/logo6.jpg') }}" class="img-responsive" alt=""></a></li>
            </ul>
        </div>
    </section>
    ...
    <section class="testimonial padding-lg">
        <div class="container">
            <div class="wrapper">
                ...
                <div id="bx-pager">
                    <a data-slide-index="0" href="#"><img src="{{ asset('assets/frontend/images/testimonial-thumb1.jpg') }}" class="img-circle" alt="" /></a>
                    <a data-slide-index="1" href="#"><img src="{{ asset('assets/frontend/images/testimonial-thumb2.jpg') }}" class="img-circle" alt="" /></a>
                    <a data-slide-index="2" href="#"><img src="{{ asset('assets/frontend/images/testimonial-thumb3.jpg') }}" class="img-circle" alt="" /></a>
                </div>
            </div>
        </div>
    </section>
