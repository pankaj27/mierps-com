    ...
    <footer class="footer">
        ...
        <div class="container">
            <div class="row row1">
                ...
                <div class="col-sm-3">
                    <div class="footer-logo hidden-xs"><a href="index-2.html"><img src="{{ asset('assets/frontend/images/footer-logo.png') }}" class="img-responsive" alt=""></a></div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="instagram">
                            ...
                            <ul class="clearfix">
                                <li><a href="#">
                                        <figure><img src="{{ asset('assets/frontend/images/insta-img1.jpg') }}" class="img-responsive" alt=""></figure>
                                    </a></li>
                                <li><a href="#">
                                        <figure><img src="{{ asset('assets/frontend/images/insta-img2.jpg') }}" class="img-responsive" alt=""></figure>
                                    </a></li>
                                <li><a href="#">
                                        <figure><img src="{{ asset('assets/frontend/images/insta-img3.jpg') }}" class="img-responsive" alt=""></figure>
                                    </a></li>
                                <li><a href="#">
                                        <figure><img src="{{ asset('assets/frontend/images/insta-img4.jpg') }}" class="img-responsive" alt=""></figure>
                                    </a></li>
                                <li><a href="#">
                                        <figure><img src="{{ asset('assets/frontend/images/insta-img5.jpg') }}" class="img-responsive" alt=""></figure>
                                    </a></li>
                                <li><a href="#">
                                        <figure><img src="{{ asset('assets/frontend/images/insta-img6.jpg') }}" class="img-responsive" alt=""></figure>
                                    </a></li>
                            </ul>
                        </div>
                    </div>
